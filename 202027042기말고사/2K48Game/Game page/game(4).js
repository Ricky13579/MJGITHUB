...
const formattedDate = `${year}-${month}-${day} ${hours}:${minutes}`;
   ...
   setTimeout(function() {
    ...
    function updateMax(num){
        if(num>maxNumber){
            maxNumber=num;
            bullet.src='D:\\MJGITHUB\\202027042기말고사\\2K48Game\\Game page\\주인공\\4.일반.특수투사체,특수투사체 마크\\특수투사체.png';
        }
...
function moveBullet(userRect, villianRect) {
    ...
    user.src='D:\\MJGITHUB\\202027042기말고사\\2K48Game\\Game page\\주인공\\2. 일반투사체발사\\일반투사체발사동작.png';
    ...
    const moveBulletInterval = setInterval(() => {
        ...
        if (distance <5) { // 원하는 threshold 값을 해주세요.
            clearInterval(moveBulletInterval);
            setTimeout(changeChar, 300);
